...
const PersonalInfoComponent = (props) => {
  ...
  //This function is triggered when the user saves the cropped img. It updates the setStoreImage state with the new picture.
  const saveImage = () => {
    setSotreImage([{ img }]);
    setOpen(false);
  };
  ...
  return (
    <Paper className="personal-info-paper" elevation={3}>
      <Avatar
        ...
        alt="profile img"
        src={
          img.length ? img : `https://icons8.com/icon/65548/add-male-user-group`
        }
      />
      <div>
        <Button
